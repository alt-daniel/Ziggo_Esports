...
<div class="page-header" style="color:orange">
    <h1 class="page_title">Overwatch</h1>
...
<div class="container-fluid">
    <div class="card text-xs-left">
        <div id="box-gray">
            <img class="card-img-top" src="img/games/overwatch_header.jpg" alt="Card image">
            ...
            <div class="collapse" id="collapse">
                <div class="card card-body">
                    ...
                    Soldiers. Scientists. Adventurers. Oddities. In a time of global crisis, an international task force of
                    heroes banded together to restore peace to a war-torn world: OVERWATCH. It ended the crisis and helped
                    to maintain peace
                    in the decades that followed, inspiring an era of exploration, innovation, and discovery. But after many
                    years, Overwatch's influence waned, and it was eventually disbanded. Overwatch is gone… but the world
                    still needs heroes.
                </div>
            </div>
        </div>
        <div id="streams" role="tabpanel" class="container-fluid" style="padding-top: 20px">
            ...
            <script>
                createRequest('ow/matches/upcoming', 3);
            </script>
