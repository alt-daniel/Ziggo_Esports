...
<p class="lead">Hier kan je evenementen bekijken die op dit moment live zijn.</p>
...
<div class="container-fluid">
    ...
    <div id='buttons' class="btn-group d-flex" role="group" style="margin-bottom: 10px">
        ...
        <a href="events_past.php" class="btn btn-dark w-100" role="button"
           style="background-color: rgb(73, 73, 73) !important;">Afgelopen matches</a>
    </div>
    <hr/>
    ...
    <div class="alert alert-warning alert-dismissible fade show" id="alert-template"
        ...
        <strong>Sorry!</strong> Er zijn momenteel geen matches bezig, check later nog een keer.
    </div>
</div>
