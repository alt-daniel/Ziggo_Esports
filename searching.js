...
httpRequest.open('GET', 'https://api.twitch.tv/kraken/search/streams?query='+localStorage.getItem("searchQuery"));
...
function clipsLoaded() {
    ...
    controlList.streams.forEach(function(stream) {
        ...
        var full=" <div id=\"\"class=\"col-lg-3 col-md-4 col-xs-12\">\n" +
            "\n" +
